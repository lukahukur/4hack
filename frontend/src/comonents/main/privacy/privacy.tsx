...
import styles from './stylesPolicy.module.scss'
  ...
  return (
    <span className={styles.wrapper}>
      <span>
        ...
        <p>
          4hack follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, 4hack uses 'cookies'. These cookies
        ...
        <p>
          ...
          each of the advertising partners of 4hack.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like
          cookies, JavaScript, or Web Beacons that are used in their
          respective advertisements and links that appear on 4hack,
        ...
        <p>
          Note that 4hack has no access to or control over these
        ...
        <p>
          4hack's Privacy Policy does not apply to other advertisers
        ...
        <p>
          4hack does not knowingly collect any Personal Identifiable
